DROP TABLE IF EXISTS `T_CORE_SERVICE_TRANS_REQUEST`;
CREATE TABLE T_CORE_SERVICE_TRANS_REQUEST
(
  trans_request_id 	BIGINT(12) NOT NULL COMMENT '主键ID',
...
DROP TABLE IF EXISTS `T_CORE_SERVICE_TRANS_CLOB`;
CREATE TABLE T_CORE_SERVICE_TRANS_CLOB
(
  clob_id     BIGINT(12) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
